...
(function (window, angular) {
    ...
    var directive = {
      ...
      link: function (scope, element, attributes, ctrl) {
        ...
        scope.triggerChange = function triggerChange(e) {
          ...
          // var $dates = $mdDateRangePicker.getSelectedDate(scope.dateStart, scope.isDisabledDate, scope.maxRange); // All selected enabled dates
          if (scope.mdOnSelect) {
  ...
  function mdDateRangePickerCtrl($scope, $filter) {
    ...
    function inCurrentMonth(date) {
      return date.getMonth() === $scope.activeMonth && date.getFullYear() === $scope.activeYear;
  ...
  function mdDateRangePickerService($mdDialog) {
    ...
    // function getSelectedDate(dateStart, isDisabledDateCallback, maxRange) {
    //   var dates = [];
    //   // var limit = dateEnd.getTime();
    //   var date = dateStart;
    //   var ctr = 0;
